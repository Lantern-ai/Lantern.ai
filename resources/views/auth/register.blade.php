<!DOCTYPE html>
<html lang="en" x-data="registerPage()">
<head>
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width,initial-scale=1" />
    <title>Register - Docs (daisyUI)</title>
        ...
        <div class="card shrink-0 w-full max-w-sm shadow-2xl bg-base-100 rounded-xl">
            <form class="card-body" method="post" action="{{route('register')}}">
                ...
                <div class="form-control">
                    ...
                    <input x-model="name" name="name" type="text" placeholder="name" class="input input-bordered" required />
                </div>
                <div class="form-control">
                    <label class="label">
                ...
                <div class="form-control">
                    ...
                    <input x-model="confirmPassword" type="password" placeholder="confirm password" class="input input-bordered" required />
                @csrf
    ...
    document.addEventListener('alpine:init', () => {
        Alpine.data('registerPage', () => ({
            ...
            handleRegister() {
                ...
                alert('Registration attempt logged to console. In a real app, you would redirect from here.');
            }
        }));
    });
</script>
